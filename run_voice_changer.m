...
% ------------------------------------------------- parse preset / in / out
presets = {'child', 'child_female', 'elder', 'elder_male', 'elder_female', ...
           'normal', 'adult', 'male', 'female', 'kid', 'girl', 'old', ...
           'old_man', 'old_woman', 'none', 'identity'};
...
'\n' ...
'ARGUMENTS\n' ...
'  1  preset     child | child_female | elder | elder_female | normal   (default child)\n' ...
...
'  --formant <r>      formant factor (default = pitch factor)\n' ...
