...
% ------------------------------------------------- parse preset / in / out
presets = {'child', 'child_soft', 'child_female', 'elder', 'elder_male', 'elder_female', ...
           'normal', 'adult', 'male', 'female', 'kid', 'kid_soft', 'child2', 'girl', 'old', ...
...
'\n' ...
'ARGUMENTS\n' ...
'  1  preset     child | child_soft | child_female | elder | elder_female | normal\n' ...
